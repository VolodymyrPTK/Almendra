...
.like-btn {
  ...
  box-shadow: inset 0 0 0 rgba(0, 0, 0, 0.4), 0 15px 15px rgba(0, 0, 0, 0.4),
    0 -1px 20px rgba(0, 0, 0, 0.2);
  margin-left: 10px;
}

.like-btn:hover {
  box-shadow: inset 0 0 0 rgba(0, 0, 0, 0.4), 0 0 0 rgba(0, 0, 0, 0.4),
